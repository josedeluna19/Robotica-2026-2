    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'click_to_motion_msgs.msg.JointControl')
            logger.debug(
...
class JointControl(metaclass=Metaclass_JointControl):
    ...
    _fields_and_field_types = {
        ...
        'joint_accelerations': 'sequence<double>',
    }
    ...
    def __init__(self, **kwargs):
        ...
        self.joint_accelerations = array.array('d', kwargs.get('joint_accelerations', []))
    ...
    def __eq__(self, other):
        ...
        if self.joint_velocities != other.joint_velocities:
            return False
        if self.joint_accelerations != other.joint_accelerations:
            return False
        return True
    ...
    def joint_accelerations(self):
        """Message field 'joint_accelerations'."""
        return self._joint_accelerations

    @joint_accelerations.setter
    def joint_accelerations(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'd', \
                "The 'joint_accelerations' array.array() must have the type code of 'd'"
            self._joint_accelerations = value
            return
        if __debug__:
            from collections.abc import Sequence
            from collections.abc import Set
