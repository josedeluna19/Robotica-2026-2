...
static const _WorkspacePosition_type_support_symbol_names_t _WorkspacePosition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, click_to_motion_msgs, msg, WorkspacePosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, click_to_motion_msgs, msg, WorkspacePosition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, click_to_motion_msgs, msg, WorkspacePosition)() {
  return &::click_to_motion_msgs::msg::rosidl_typesupport_c::WorkspacePosition_message_type_support_handle;
}
