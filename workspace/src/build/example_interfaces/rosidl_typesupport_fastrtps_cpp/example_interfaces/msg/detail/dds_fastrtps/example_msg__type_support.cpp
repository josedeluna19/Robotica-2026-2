...
#include "example_interfaces/msg/detail/example_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const example_interfaces::msg::ExampleMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  example_interfaces::msg::ExampleMsg & ros_message)
{
  // Member: message
  cdr >> ros_message.message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = example_interfaces::msg::ExampleMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const example_interfaces::msg::ExampleMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<example_interfaces::msg::ExampleMsg *>(
    untyped_ros_message);
...
{
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_ExampleMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_interfaces, msg, ExampleMsg)() {
  return &example_interfaces::msg::typesupport_fastrtps_cpp::_ExampleMsg__handle;
}
