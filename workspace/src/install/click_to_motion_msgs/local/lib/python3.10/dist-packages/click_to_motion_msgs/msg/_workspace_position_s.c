...
bool click_to_motion_msgs__msg__workspace_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("click_to_motion_msgs.msg._workspace_position.WorkspacePosition", full_classname_dest, 62) == 0);
  }
  click_to_motion_msgs__msg__WorkspacePosition * ros_message = _ros_message;
  {  // robot_id
...
{
  /* NOTE(esteve): Call constructor of WorkspacePosition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("click_to_motion_msgs.msg._workspace_position");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WorkspacePosition");
