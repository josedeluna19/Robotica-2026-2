...
class HardwareInterface(Node):
  def __init__(self):
    ...
    self.current_joint_state.name = ["turret_joint", "shoulder_joint", "arm_joint"]
  ...
  def joint_states_timer_callback(self):
    ...
    msg.name = ["turret_joint", "shoulder_joint", "arm_joint"]
    msg.position = self.current_joint_state.position
